...
final class DTTextField: UITextField {
    ...
    internal var dtLayer:CALayer                              = CALayer()
    internal var floatPlaceholderColor:UIColor                = UIColor.black
    internal var floatPlaceholderActiveColor:UIColor          = UIColor.black
    internal var floatingLabelShowAnimationDuration           = 0.3
    internal var floatingDisplayStatus:FloatingDisplayStatus  = .defaults
    ...
    internal var dtborderStyle:DTBorderStyle = .rounded {
        didSet {
    ...
    internal var animateFloatPlaceholder:Bool = true
    internal var hideErrorWhenEditing:Bool   = true
    
    internal var errorFont = UIFont.systemFont(ofSize: 10.0) {
        didSet {
    ...
    internal var errorTextColor = UIColor.red {
        didSet {
            lblError.textColor = errorTextColor
        }
    }
    
    internal var floatPlaceholderFont = UIFont.systemFont(ofSize: 10.0) {
        didSet {
    ...
    internal var paddingYFloatLabel:CGFloat = 3.0 {
        didSet { invalidateIntrinsicContentSize() }
    }
    
    internal var paddingYErrorLabel:CGFloat = 3.0 {
        didSet { invalidateIntrinsicContentSize() }
    }
    
    internal var borderColor:UIColor = UIColor(red: 204.0/255.0, green: 204.0/255.0, blue: 204.0/255.0, alpha: 1.0) {
        didSet {
            switch dtborderStyle {
    ...
    internal var canShowBorder:Bool = true {
        didSet {
            switch dtborderStyle {
            case .none,.rounded,.sqare:
    ...
    override internal var borderStyle: UITextField.BorderStyle {
        didSet {
    ...
    internal override var textAlignment: NSTextAlignment {
    ...
    override internal var attributedPlaceholder: NSAttributedString? {
    ...
    internal func showError(message:String? = nil) {
